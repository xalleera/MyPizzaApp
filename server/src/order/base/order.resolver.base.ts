...
export class OrderResolverBase {
  ...
  async createOrder(@graphql.Args() args: CreateOrderArgs): Promise<Order> {
    return await this.service.create({
      ...
      data: {
        ...
        drink: args.data.drink
          ? {
              connect: args.data.drink,
            }
          : undefined,
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => Drink, { nullable: true })
  @nestAccessControl.UseRoles({
    resource: "Drink",
    action: "read",
    possession: "any",
  })
  async drink(@graphql.Parent() parent: Order): Promise<Drink | null> {
    const result = await this.service.getDrink(parent.id);
